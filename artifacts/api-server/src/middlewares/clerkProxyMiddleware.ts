 ...
 *
 * Proxies Clerk Frontend API requests through your own domain, enabling Clerk
 * authentication on custom domains without requiring CNAME DNS configuration.
 *
 * Set VITE_CLERK_PROXY_URL in your production environment to activate this.
 * In development it is a no-op (Clerk hits its dev FAPI directly).
 *
 * IMPORTANT:
